...
export var tracker = {
  ...
  sendDataToServer: function (data) {
    ...
    if (XHR) {
      const url = process.env.NODE_ENV !== 'production' ? 'http://47.100.14.188:8086' : 'https://sxyp.sxfqsc.com/';
      XHR.open('POST', url, true);//  http://47.100.14.188:8086   --测试地址   //sxyp.sxfqsc.com --生产地址

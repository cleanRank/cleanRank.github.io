<template>
  <div class="floor-nine">
    <div class="seckill-wrap">
      ...
      <ul>
        <ModelImgGood class="floor-single-row" v-for="(good, index) in products" :key="index" :good="good" :rebateStatus="floor.rebateStatus" :seckill="seckill"></ModelImgGood>
      </ul>
    </div>
  </div>
</template>
<script type="text/javascript">
  ...
  import ModelImgGood from './ModelImgGood'
  export default {
    mixins: [mixin],
    data () {
      return {
